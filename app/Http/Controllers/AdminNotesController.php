<?php namespace App\Http\Controllers;
	...
	class AdminNotesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Event","name"=>"event"];
			...
			$this->form[] = ['label'=>'Content','name'=>'content','type'=>'text','validation'=>'required|string|min:3|max:70','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only'];
